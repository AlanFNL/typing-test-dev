...
const TypingTest = () => {
  ...
  const calculateResults = () => {
    ...
    const typedWords = typed.split(" ").filter((word) => word.length > 0);
    ...
    const totalAttempts = totalKeystrokes + errors;
    const accuracy = Math.round((correctKeystrokes * 100) / totalAttempts);
